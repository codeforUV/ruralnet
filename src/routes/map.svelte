...
<div class="results-container">
  <div id="map" class="map-container">
    ...
    {:then docs}
      {#if docs.length === 0}
        <p>Looks like you haven't tested yet. <a href="/">Take a test.</a></p>
      {:else}
        <small>
          <a
    ...
    <div class="explination-container">
      ...
      <div class="legend">
        <div class="legend-user">
          ...
          <span>
            Represented by a colored circle in the general location where the speed test was
            performed</span
          >
        </div>
      </div>
      <div>
        ...
        <div class="row-fluid">
          ...
          <p>
            ...
            corner of the map and then click on the right arrow next to the "Percent Broadband"
            layer. To view the "Underserved" layer, turn off the Percent Broadband layer and you'll
            see the Underserved percentage.
          </p>
