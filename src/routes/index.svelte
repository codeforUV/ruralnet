  ...
  <div class="jumbotron-content-background">
    <div class="content">
      {#if showDefault === true}
        ...
        <small class="wow fadeInUp" data-wow-delay=".2s"
          ><a href="map">Skip to Results Map →</a></small
        >
      {:else if showSpeedTest === true}
        ...
        {#if showSurveyBtn === true}
          ...
          <button id="survey" class="btn btn-blue" on:click={renderSurvey}
            >Take A Quick Survey!</button
          >
        {/if}
        <small class="wow fadeInUp" data-wow-delay=".2s"
          ><a href="map">Skip to Results Map →</a></small
