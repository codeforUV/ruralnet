<script>
  ...
  let surveyInfo = [
    ...
    },
    {
      _id: 2,
      question:
        'Approximately how many other devices are using your internet while you ran the test? (Other people in your home that are online, Alexa, smart home devices, security cameras, etc.)',
      answerName: 'devices',
      answerType: 'radio',
    ...
    },
    {
      _id: 4,
      question:
        'Which of the following is this internet connection used for? (check all that apply)',
      answerName: 'uses',
      answerType: 'checkbox',
      answerOptions: [
        'K-12 Education',
...
<div class="survey-container">
  ...
  <div class="question-options">
          ...
          <div class="check-item input-container">
            ...
            {#if option == 'Other'}
              <input
                ...
                name={option}
                id={option}
                bind:value={surveyInfo[questionNumber].other}
              />
            {/if}
          </div>
        {/each}
    ...
    {:else if questionNumber === 5}
      <textarea bind:value={surveyInfo[questionNumber].answer} rows="4" />
    {:else}
      <div>
        Error: Input for this survey question has not been accounted for. (index:{questionNumber} of
        surveyInfo. Component: Survey.svelte)
      </div>
    {/if}
  </div>
  <div class="btn-row">
