...
require('fast-speed-test');
var speedTest = _interopDefault(require('speedtest-net'));
...
<div><button>Get Speed</button>
  <button>Post Form</button>
  <input type="${"text"}" placeholder="${"type something"}"${add_attribute("value", clientForm, 1)}>
  ${ ``}</div>`;
});
